# coding: utf-8
# Input: Primer file and pimer information file
# Process: Find the primer in primer information file
# Output: The primer information contains only the primers in primer file.
import os
import sys
import copy
