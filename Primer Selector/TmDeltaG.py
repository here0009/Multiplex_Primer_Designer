...
def calTm(qseq, monovalent_conc, divalent_conc, oligo_conc, dNTP_conc):
    ...
    (delta_H, delta_S) = calDeltaHS(qseq, qseq)
...
def main():
    qseq = 'ACCACAGGATTCACTTGATGAACGA'
    sseq = qseq
    mono = 50
    diva = 1.5
    oligo = 50
    dntp = 0.25
    print(calTm(qseq, mono, diva, oligo, dntp))
